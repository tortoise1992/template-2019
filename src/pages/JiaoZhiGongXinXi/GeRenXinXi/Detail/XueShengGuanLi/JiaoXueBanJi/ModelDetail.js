...
export default class ModelDetail extends Component {
    ...
    //导出接口
    handleExport = () => {
        // const { curYear, curCollege, curMajor, curClass, curGrade } = this.props.filterValue;
        // window.location.href = `${hostUrl}/bigdata/portrait/exportScholarshipInfo?year=${curYear}&collegeCode=${curCollege}&majorCode=${curMajor}&grade=${curGrade}&classCode=${curClass}`
    }
            ...
            <Modal
                title={
                    <React.Fragment>
                        ...
                        <Tooltip title={`下载${this.props.data.class}列表`}>
                            <Icon onClick={this.handleExport} type="vertical-align-bottom" style={{cursor:"pointer", marginLeft: 10}} />
                        </Tooltip>
                    </React.Fragment>
                }
