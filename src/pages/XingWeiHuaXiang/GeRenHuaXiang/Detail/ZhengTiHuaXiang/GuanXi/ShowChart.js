...
export default class ShowChart extends Component {
    ...
    setRelationshipUI = (data) => {
        const showWidth = document.getElementById("root").clientWidth - 315;
        const {nodes, edges} = data;
        const relationsId = this.state.relationsId;
        let width = showWidth;//设置宽度
        let height = this.props.height ||  560;//设置高度
        let img_w = 20;
        let img_h = 20;
        let radius = 20;    //圆形半径
