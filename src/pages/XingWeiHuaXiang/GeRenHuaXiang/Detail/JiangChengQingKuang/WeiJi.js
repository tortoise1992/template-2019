...
export default class WeiJi extends Component {

    state = {
        dataSource: [
            { sortIndex: 1, key: 1, time: '2017-12-27 17:46:12', type: '严重警告处分', reason: '原因' },
        ],
        columns: [
            {
                title: '序号',
    ...
    render() {
        return (
            <Card
                ...
                title={<div className={styles.cardTitle}>个人违纪处分列表</div>}
                extra={<DownLoad
