...
export default class JiangZhuList extends Component {

    state = {
        dataSource: [
            { sortIndex: 1, key: 1, time: '2017-12-27 17:46:12', name: '国家励志奖学金', price: 5000 },
        ],
        columns: [
            {
                title: '序号',
    ...
    render() {
        return (
            <Card
                ...
                title={<div className={styles.cardTitle}>个人奖助列表</div>}
                extra={<DownLoad
